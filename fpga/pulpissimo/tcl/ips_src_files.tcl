...
# axi_mem_if
set SRC_AXI_MEM_IF " \
    $IPS/axi/axi_mem_if/src/axi2mem.sv \
    $IPS/axi/axi_mem_if/src/deprecated/axi_mem_if.sv \
    $IPS/axi/axi_mem_if/src/deprecated/axi_mem_if_wrap.sv \
    $IPS/axi/axi_mem_if/src/deprecated/axi_mem_if_var_latency.sv \
"
...
set SRC_UDMA_EXTERNAL_PER " \
    $IPS/udma/udma_external_per/rtl/RX_serializer.sv \
    $IPS/udma/udma_external_per/rtl/udma_mram_reg_if.sv \
    $IPS/udma/udma_external_per/rtl/udma_mram_top.sv \
    $IPS/udma/udma_external_per/rtl/size_conv_TX_32_to_64.sv \
    $IPS/udma/udma_external_per/rtl/size_conv_RX_64_to_32.sv \
    $IPS/udma/udma_external_per/rtl/TX_RX_to_MRAM.sv \
    $IPS/udma/udma_external_per/rtl/udma_dc_fifo_mram.sv \
    $IPS/udma/udma_external_per/rtl/dc_token_ring_fifo_din_mram.v \
    $IPS/udma/udma_external_per/rtl/dc_full_detector_mram.v \
    $IPS/udma/udma_external_per/rtl/udma_mram_macro_wrapper.sv \
    $IPS/udma/udma_external_per/rtl/udma_mram_domain.sv \
    $IPS/udma/udma_external_per/rtl/udma_mram_top_wrapper.sv \
"
...
set SRC_HWPE_STREAM " \
    ...
    $IPS/hwpe-stream/rtl/hwpe_stream_assign.sv \
...
set SRC_HW_MAC_ENGINE " \
    ...
    $IPS/hwpe-mac-engine/rtl/parameters.sv \
    $IPS/hwpe-mac-engine/rtl/32bTO64b.sv \
    ...
    $IPS/hwpe-mac-engine/rtl/panda_fsm.sv \
    $IPS/hwpe-mac-engine/rtl/activation_memory.sv \
    $IPS/hwpe-mac-engine/rtl/adder.sv \
    $IPS/hwpe-mac-engine/rtl/adder_tree.sv \
    $IPS/hwpe-mac-engine/rtl/array_pes.sv \
    $IPS/hwpe-mac-engine/rtl/sparsity_memory.sv \
    $IPS/hwpe-mac-engine/rtl/output_allignment_padding.sv \
    $IPS/hwpe-mac-engine/rtl/instruction_memory.sv \
    $IPS/hwpe-mac-engine/rtl/inner_wrapper_SRAM_act_mem.sv \
    $IPS/hwpe-mac-engine/rtl/inner_wrapper_SRAM_w_mem.sv \
    $IPS/hwpe-mac-engine/rtl/outter_wrapper_SRAM_w_mem.sv \
    $IPS/hwpe-mac-engine/rtl/encoder_FIFO.sv \
    $IPS/hwpe-mac-engine/rtl/configuration_registers.sv \
    $IPS/hwpe-mac-engine/rtl/control_unit.sv \
    $IPS/hwpe-mac-engine/rtl/cpu.sv \
    $IPS/hwpe-mac-engine/rtl/cpu_wrapper.sv \
    $IPS/hwpe-mac-engine/rtl/input_buffer.sv \
    $IPS/hwpe-mac-engine/rtl/multiplier.sv \
    $IPS/hwpe-mac-engine/rtl/mult_top.sv \
    $IPS/hwpe-mac-engine/rtl/nonlinear_block.sv \
    $IPS/hwpe-mac-engine/rtl/pe.sv \
    $IPS/hwpe-mac-engine/rtl/pooling.sv \
    $IPS/hwpe-mac-engine/rtl/sig_tanh.sv \
    $IPS/hwpe-mac-engine/rtl/SRAM_parametrizable_equivalent.sv \
    $IPS/hwpe-mac-engine/rtl/SRAM_parametrizable_w_equivalent.sv \
    $IPS/hwpe-mac-engine/rtl/SRAM_parametrizable_s_equivalent.sv \
    $IPS/hwpe-mac-engine/rtl/SRAM_2048x64_equivalent.sv \
    $IPS/hwpe-mac-engine/rtl/SRAM_2048x32_equivalent.sv \
    $IPS/hwpe-mac-engine/rtl/weight_memory.sv \
"
...
set SRC_COMPONENTS " \
    ...
    $IPS/pulp_soc/rtl/components/apb_wakeup.sv \
    $IPS/pulp_soc/rtl/components/apb_wakeup_counter.sv \
"
set INC_COMPONENTS " \
    $IPS/pulp_soc/../../rtl/includes \
"
